        ...
        <form @submit.prevent="signIn" class="card card-form">
            ...
            <div class="form-group">
                ...
                <template v-if="$v.form.password.$error">
                  ...
                  <span v-if="!$v.form.password.minLength" class="form-error">This password must be at least 6 characters long</span>
                </template>
            </div>
  ...
  methods: {
    signIn () {
      ...
      if (!this.$v.form.$invalid) {
        this.$store.dispatch('auth/signInUserWithEmailAndPassword', {
